...
const I18N = {
  fr: {
    ...
    section_sort: 'Ordre de tri',
    sort_desc: 'Décroissant',
    sort_asc: 'Croissant',
    nav_recap: 'Récap',
    nav_back: 'Télécharger',
    recap_title: 'Récapitulatif de vos musiques',
    recap_sub: 'Importez un fichier exporté depuis ce site (CSV, Excel ou JSON) pour voir un résumé.',
    recap_drop: 'Glissez un fichier ici, ou cliquez pour le choisir',
    recap_choose: 'Choisir un fichier',
    recap_error_parse: 'Impossible de lire ce fichier. Vérifiez qu\u2019il provient bien d\u2019un export de ce site.',
    recap_top_artists: 'Artistes les plus écoutés',
    recap_top_tracks: 'Morceaux les plus écoutés',
    recap_busiest_day: 'Jour le plus actif',
    recap_avg_per_day: 'Moyenne / jour actif',
    recap_avg_per_item: 'Moyenne par élément',
    recap_monthly: 'Répartition par mois',
    recap_weekday: 'Répartition par jour de la semaine',
  ...
  en: {
    ...
    section_sort: 'Sort order',
    sort_desc: 'Descending',
    sort_asc: 'Ascending',
    nav_recap: 'Recap',
    nav_back: 'Download',
    recap_title: 'Your music recap',
    recap_sub: 'Import a file exported from this site (CSV, Excel, or JSON) to see a summary.',
    recap_drop: 'Drag a file here, or click to choose one',
    recap_choose: 'Choose a file',
    recap_error_parse: 'Couldn\u2019t read this file. Make sure it comes from an export of this site.',
    recap_top_artists: 'Most played artists',
    recap_top_tracks: 'Most played tracks',
    recap_busiest_day: 'Busiest day',
    recap_avg_per_day: 'Avg. per active day',
    recap_avg_per_item: 'Average per item',
    recap_monthly: 'Monthly breakdown',
    recap_weekday: 'Day-of-week breakdown',
